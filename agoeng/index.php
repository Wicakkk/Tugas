<?php include '/xampp/htdocs/BLOCKING_XI/agoeng/config.php'; ?>
            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    while ($row = $panggil->fetch_assoc()) {
                        $gambarDir = '/xampp/htdocs/BLOCKING_XI/agoeng/assets/img/';
                        $namaGambar = $row['gambar'];
                        $gambar = $gambarDir . $namaGambar . '.jpg';
                        echo "<img src='$gambarDir$namaGambar' alt='Gambar'>";
                    ?>
                        <div class="carousel-item <?php if ($row['status'] == 'aktif') echo 'active'; ?>" data-bs-interval="4000">
